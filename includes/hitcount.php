...
case 'index.php':
	...
	break;
case 'individual.php':
	$page_parameter = KT_Filter::get('pid', KT_REGEX_XREF);
	break;
case 'family.php':
	$page_parameter = KT_Filter::get('famid', KT_REGEX_XREF);
	break;
case 'source.php':
	$page_parameter = KT_Filter::get('sid', KT_REGEX_XREF);
	break;
case 'repo.php':
	$page_parameter = KT_Filter::get('rid', KT_REGEX_XREF);
	break;
case 'note.php':
	$page_parameter = KT_Filter::get('nid', KT_REGEX_XREF);
	break;
case 'mediaviewer.php':
	$page_parameter = KT_Filter::get('mid', KT_REGEX_XREF);
	break;
default:
	$page_parameter = '';
	break;
