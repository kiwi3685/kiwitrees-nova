...
//define('KT_SCRIPT_NAME', 'specialcharacters.php');
...
$otherspecialchars = array(
	...
	"&#x2039;" => "‹",
	"&#x203A;" => "›",
	"&#x2013;" => "–", // en-dash (e.g. for ranges, such as 1979–1980)
	...
	<form name="filterspecialchar" method="get" action="find.php">
		...
		<p>
			<select id="language_filter" name="language_filter" onchange="submit();">
				<option value=""><?php echo KT_I18N::translate('Change language'); ?></option>
					<?php $language_options = '';
...
<div id="find-output-special" class="cell">
	<p>
		<!-- lower case special characters -->
		<?php foreach ($lcspecialchars as $key=>$value) { ?>
			<a class="largechars" href="#" onclick="return window.pastefield('<?php echo $value; ?>');">
				<?php echo $key; ?>
			</a>
		<?php } ?>
	</p>
