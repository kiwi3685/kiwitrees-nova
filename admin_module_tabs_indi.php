...
$controller
	...
	->pageHeader()
	->addInlineJavascript('
    jQuery("#tabiTable").sortable({items: ".sortme", forceHelperSize: true, forcePlaceholderSize: true, opacity: 0.7, cursor: "move", axis: "y"});

    //-- update the order numbers after drag-n-drop sorting is complete
    jQuery("#tabiTable").bind("sortupdate", function(event, ui) {
