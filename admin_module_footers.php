...
$controller
	...
	->pageHeader()
	->addInlineJavascript('
    jQuery("#footers_table").sortable({items: ".sortme", forceHelperSize: true, forcePlaceholderSize: true, opacity: 0.7, cursor: "move", axis: "y"});

    //-- update the order numbers after drag-n-drop sorting is complete
    jQuery("#footers_table").bind("sortupdate", function(event, ui) {
...
<div id="footers" class="cell">
	<form method="post" action="<?php echo KT_SCRIPT_NAME; ?>">
		...
		<table id="footers_table" class="modules_table">
			<thead>
				<tr>
					<th><?php echo KT_I18N::translate('Footer block'); ?></th>
