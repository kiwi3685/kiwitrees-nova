...
$controller
	...
	->pageHeader()
	->addInlineJavascript('
    jQuery("#sidebarTable").sortable({items: ".sortme", forceHelperSize: true, forcePlaceholderSize: true, opacity: 0.7, cursor: "move", axis: "y"});

    //-- update the order numbers after drag-n-drop sorting is complete
    jQuery("#sidebarTable").bind("sortupdate", function(event, ui) {
...
$col1Header = KT_I18N::translate('Sidebar');
$sortAble   = true;
