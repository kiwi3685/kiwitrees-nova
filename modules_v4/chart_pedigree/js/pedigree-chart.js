...
//================  start modified  ================//
		 ...
		 addImage(t) {
			t.append("svg:image")
				.attr("xlink:href",
			t => t.data.thumbnail ? t.data.thumbnail : t.data.sex === Zi ? "modules_v4/chart_pedigree/images/silhouette_female.png" : t.data.sex === Wi ? "modules_v4/chart_pedigree/images/silhouette_male.png" : "modules_v4/chart_pedigree/images/silhouette_unknown.png")
