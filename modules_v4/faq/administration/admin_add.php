...
$controller
	->setPageTitle(KT_I18N::translate('Add an faq item'))
	->pageHeader()
...
if ($save) {
	...
	$item_content = KT_Filter::post('faq_content', KT_REGEX_UNSAFE);
	$item_access  = KT_Filter::post('faq_access',  KT_REGEX_UNSAFE);
	$languages    = array();
...
echo pageStart('faq_details', $controller->getPageTitle()); ?>
	...
	<form class="cell" name="faq" method="post" action="module.php?mod=<?php echo $this->getName(); ?>&amp;mod_action=admin_add">
