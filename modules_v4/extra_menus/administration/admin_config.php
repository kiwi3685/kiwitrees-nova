...
echo pageStart($this->getName(), KT_I18N::translate('Extra menus'), '', '', ''); ?>

	<fieldset class="cell fieldset">
		<legend class="h5"><?php echo KT_I18N::translate('Site menu'); ?></legend>
		<div class="grid-x">
	...
	<fieldset class="cell fieldset">
		<legend class="h5"><?php echo KT_I18N::translate('Menu list'); ?></legend>
		<div class="grid-x">
						...
						<tbody>
							...
							if (!$gedID) {
								...
								foreach ($items as $menu) {
									if ($menu->gedcom_id == $gedID || is_null($menu->gedcom_id)) {
										$menuItems[] = $menu;
									}
								}
								$items = $menuItems;
							...
							foreach ($items as $item) { ?>
								<tr class="sortme">
									...
									<td>
										<a href="module.php?mod=<?php echo $this->getName(); ?>&amp;mod_action=admin_delete&amp;block_id=<?php echo $item->block_id; ?>" onclick="return confirm('<?php echo KT_I18N::translate('Are you sure you want to delete this menu entry?'); ?>');">
											<?php echo KT_I18N::translate('Delete'); ?>
										</a>
									</td>
									<td>
										<a href="<?php echo $item->menu_address; ?>" target="_blank">
