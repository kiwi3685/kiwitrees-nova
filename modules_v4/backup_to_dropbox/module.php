...
class backup_to_dropbox_KT_Module extends KT_Module implements KT_Module_Config {
	...
	private function config() {
		...
		<div id="backup_to_dropbox-page">
			<a class="current faq_link" href="http://kiwitrees.net/faqs/modules/backup-dropbox/" target="_blank" rel="noopener noreferrer" title="<?php echo KT_I18N::translate('View FAQ for this page.'); ?>"><?php echo KT_I18N::translate('View FAQ for this page.'); ?><i class="' . $iconStyle . ' fa-comments-o"></i></a>
