...
class TreeView {
	 ...
	 *
	 * @param $rootPerson  the id of the root person
	 ...
	 *
	 * @param $individual the individual to return the details for
	 *
	 * @return string
	 */
	 ...
	 */
	private function drawPerson($person, $gen, $state, $pfamily = null, $order = null, $isRoot = false) {
	 ...
	 * @return string
	 */
	private function getThumbnail($individual) {
