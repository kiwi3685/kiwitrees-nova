...
*/
		$content .= '<table>
			<tr>
				...
				if (KT_USER_IS_ADMIN) {
					$content .= '<td><a href="admin.php"><i class="' . $iconStyle . ' fa-cogs"></i><br>' . KT_I18N::translate('Administration') . '</a></td>';
				}
			$content .= '</tr>
		</table>';
