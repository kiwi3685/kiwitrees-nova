...
*/
		$content .= '<table>
			<tr>
				<td><a href="edituser.php"><i class="' . $iconStyle . ' fa-user"></i><br>' . KT_I18N::translate('My account') . '</a></td>';
				if (KT_USER_GEDCOM_ID) {
					$content .= '
						<td><a href="pedigree.php?rootid=' . KT_USER_GEDCOM_ID.'&amp;ged=' . KT_GEDURL . '"><i class="' . $iconStyle . ' fa-sitemap"></i><br>' . KT_I18N::translate('My pedigree') . '</a></td>
						<td><a href="individual.php?pid=' . KT_USER_GEDCOM_ID.'&amp;ged=' . KT_GEDURL . '"><i class="' . $iconStyle . ' fa-id-badge"></i><br>' . KT_I18N::translate('My individual record') . '</a></td>';
				}
				if (KT_USER_IS_ADMIN) {
					$content .= '<td><a href="admin.php"><i class="' . $iconStyle . ' fa-gears"></i><br>' . KT_I18N::translate('Administration') . '</a></td>';
				}
			$content .= '</tr>
		</table>';
		...
		echo '
			...
			<tr>
				<td>
					<p>
						<label>Icon:</label>
						<span class="custom-icon-container"><i class="' . $iconStyle . ' fa-star"></i></span>
