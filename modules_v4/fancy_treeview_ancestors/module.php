...
class fancy_treeview_ancestors_KT_Module extends KT_Module implements KT_Module_Config, KT_Module_Menu, KT_Module_Report {

	// Extend KT_Module
	public function getTitle() {
		return /* I18N: Name of the module */ KT_I18N::translate('Ancestors');
	}

	// Extend KT_Module
	public function getDescription() {
		return /* I18N: Description of the module */ KT_I18N::translate('A narrative report of the ancestors of one individual');
	}
	...
	public function modAction($mod_action) {
		...
		switch($mod_action) {
		case 'admin_config':
			require KT_ROOT . KT_MODULES_DIR . $this->getName() . '/admin_fancy_treeview_ancestors.php';
			break;
		case 'admin_reset':
	...
	private function show() {
		...
		if($root_person && $root_person->canDisplayName()) {
			$controller
				->setPageTitle(/* I18N: %s is the surname of the root individual */ KT_I18N::translate('Ancestors of %s', $root_person->getFullName()))
				->pageHeader()
					...
					<div id="page-body">
						...
						<div id="btn_next">
							<button class="btn btn-next" type="button" name="next" value="<?php echo KT_I18N::translate('next'); ?>" title="<?php echo KT_I18N::translate('Show more generations'); ?>">
								<i class="' . $iconStyle . ' fa-arrow-down"></i>
	...
	public function getMenu() {
		...
		$menu = null;
		if (empty($controller) || array_key_exists('fancy_treeview_descendants', KT_Module::getActiveModules())) {
			return null;
		}
