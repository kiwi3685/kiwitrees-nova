...
class album_KT_Module extends KT_Module implements KT_Module_IndiTab, KT_Module_Config {
	...
	private function config() {
		...
		$html = '<div id="album_config">';
			$html .= '<a class="current faq_link" href="http://kiwitrees.net/faqs/modules-faqs/album/" target="_blank" rel="noopener noreferrer" title="'. KT_I18N::translate('View FAQ for this page.'). '">'. KT_I18N::translate('View FAQ for this page.'). '<i class="' . $iconStyle . ' fa-comments-o"></i></a>
