...
class block_pending_KT_Module extends KT_Module implements KT_Module_Block {
	...
	public function getBlock($block_id, $template = true, $cfg = null) {
		global $ctype, $KIWITREES_EMAIL, $iconStyle;
	...
	public function configureBlock($block_id) {
		...
		<div class="cell medium-5">
			 <label><?php echo KT_I18N::translate('Send out reminder emails?'); ?></label>
		</div>
		<div class="cell medium-7">
			<?php echo edit_field_yes_no('sendmail', $sendmail); ?>
		</div>
		<hr>
		<div class="cell medium-5">
			 <label><?php echo KT_I18N::translate('Reminder email frequency (days)'); ?></label>
		</div>
		<div class="cell medium-7">
			<input type='text' name='days' value='<?php $days; ?>' size='2'>
		</div>
		<hr>
		<div class="cell medium-5">
