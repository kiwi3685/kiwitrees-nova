...
echo pageStart($this->getName(), $extendedPageTitle); ?>
	...
	<form class="cell" name="people" method="get" action="?">
		...
		<div class="grid-x grid-margin-x">
			<div class="cell medium-4">
				<label class="h5" for = "pid1"><?php echo KT_I18N::translate('Individual 1') ?></label>
				<input class="pedigree_form" data-autocomplete-type="INDI" type="text" name="pid1" id="pid1" value="<?php echo $pid1; ?>">
			</div>
			<div class="cell medium-4">
				<label class="h5" for = "pid2"><?php echo KT_I18N::translate('Individual 2') ?></label>
			...
			<div class="cell medium-2">
				...
				<button class="button primary swap" onclick="var x = jQuery('#pid1').val(); jQuery('#pid1').val(jQuery('#pid2').val()); jQuery('#pid2').val(x); return false;">
