...
try {
	KT_DB::updateSchema(KT_ROOT . KT_MODULES_DIR . 'block_news/db_schema/', 'NB_SCHEMA_VERSION', 3);
} catch (PDOException $ex) {
	// The schema update scripts should never fail.  If they do, there is no clean recovery.
	die($ex);
}

class block_news_KT_Module extends KT_Module implements KT_Module_Block {
