...
//				"sDom": \'<"H"pBf<"dt-clear">irl>t<"F"pl>\',
			...
			<?php if ($person && $person->canDisplayDetails()) { ?>
				...
				<div class="help_text">
					<div class="help_content">
						...
						<a href="#" class="more noprint">
							<i class="<?php echo $iconStyle; ?> fa-question-circle"></i>
						</a>
						<div class="hidden">
	...
	protected static function updateSchema() {
		...
		try {
			KT_DB::updateSchema(KT_ROOT . KT_MODULES_DIR . 'tabi_dna/db_schema/', 'DNA_SCHEMA_VERSION', 1);
