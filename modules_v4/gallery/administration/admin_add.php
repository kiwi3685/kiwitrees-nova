...
if ($save) {
    ...
    if ('uploads' == get_block_setting($block_id, 'gallery_plugin')) {
...
window.location = 'module.php?mod=<?php echo $this->getName(); ?>&mod_action=admin_edit&block_id=<?php echo $block_id; ?>&gedID=<?php echo $gedID; ?>
        ...
        case 2:
            ...
            ?>
<script>
window.location = 'module.php?mod=<?php echo $this->getName(); ?>&mod_action=admin_config&gedID=<?php echo $gedID; ?>';
</script>
<?php
        break;
...
<form class="cell" name="gallery" method="post" action="module.php?mod=<?php echo $this->getName(); ?>&amp;mod_action=admin_add">
        ...
        <div class="cell medium-10">
            ...
            <div class="grid-x grid-margin-x flickrInputGroup" style="display:none;">
                <div class="input-group cell medium-6">
                    ...
                    <input class="input-group-field" id="flickr" type="text" name="gallery_folder" value="" placeholder="123456789123456789" disabled>
                </div>
                <div class="cell callout info-help">
            ...
            <div class="grid-x grid-margin-x uploadsInputGroup" style="display:none;">
                <div class="input-group cell medium-6">
                    ...
                    <input class="input-group-field" id="uploads" type="text" name="gallery_folder" value="" placeholder="<?php echo /* Placeholder for a user created file name */ KT_I18N::translate('my folder name'); ?>" disabled>
                </div>
                <div class="cell callout info-help">
