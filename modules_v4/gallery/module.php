...
class gallery_KT_Module extends KT_Module implements KT_Module_Menu, KT_Module_Block, KT_Module_Config {
	...
	private function mediaDisplay($sub_folder, $item_id, $version) {
		...
		if ($images) {
			$html .= $images.
				'</div>'.// close #galleria
				'<a id="copy" href="https://galleriajs.github.io/" target="_blank" rel="noopener noreferrer">' . /* I18N: Copyright statement in gallery module */ KT_I18N::translate('Display courtesey of Galleria (%1s)', $version) . '</a>'.// gallery.io attribution
				'</div>'.// close #page
