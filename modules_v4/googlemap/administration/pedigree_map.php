...
<div id="pedigreemap-page">
    ...
    <form name="people" method="get" action="module.php?ged=<?php echo KT_GEDURL; ?>&amp;mod=googlemap&amp;mod_action=pedigree_map">
        ...
        <div class="chart_options">
            <label for = "rootid" style="display:block; font-weight:900;">
                <?php echo KT_I18N::translate('Individual'); ?>
            </label>
                <input data-autocomplete-type="INDI" type="text" id="rootid" name="rootid" value="<?php echo $controller->root->getXref(); ?>">
...
echo pedigree_map_js();


function pedigree_map_js() {
    ...
    $priv=0;
    $count=0;
    $event = '<img src="googlemap/images/sq1.png" width="10" height="10">'.
    ...
    for ($i=0; $i<($controller->treesize); $i++) {
        ...
        if ($person) {
            ...
            $event = '<img src=\"googlemap/images/sq' . $curgen . '.png\" width=\"10\" height=\"10\">'.
