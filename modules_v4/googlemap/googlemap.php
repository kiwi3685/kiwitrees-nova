...
function print_fact_place_map($factrec) {
	...
	if ($ct > 0) {
		...
		$retStr	.= '<a href="placelist.php?action=view';
		...
		<div  id="map_content" class="cell">
			<table>
				...
				foreach($markers as $marker) { ?>
					<tr>
						<td>
							<a href="#" onclick="myclick(<?php echo $z; ?>, <?php echo $marker['index']; ?>, <?php echo $marker['tabindex']; ?>)">
								<?php echo $marker['fact_label']; ?>
							</a>
						</td>
						<?php $z ++; ?>
						<td>
...
function NEWbuild_indiv_map($indifacts, $famids) {
	global $controller, $GOOGLEMAP_MAX_ZOOM, $GM_DEFAULT_TOP_VALUE;
