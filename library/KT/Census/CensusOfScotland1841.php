 ...
 */
class KT_Census_CensusOfScotland1841 extends KT_Census_CensusOfScotland implements KT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new KT_Census_CensusColumnBornForeignParts($this, 'BoS', 'Born outside Scotland'),
		);
	}
}
