 ...
 */
class KT_Census_CensusOfFrance1872 extends KT_Census_CensusOfFrance implements KT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new KT_Census_CensusColumnBirthPlace($this, 'Nationalité', 'Nationalité - Lieu de naissance'),
		);
	}
}
