 ...
 */
class KT_Census_CensusOfEngland1911 extends KT_Census_CensusOfEngland implements KT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new KT_Census_CensusColumnOccupation($this, 'Occupation', 'Rank, profession or occupation', 'width: 100px;'),
			...
			new KT_Census_CensusColumnBirthPlace($this, 'Birthplace', 'Where born', 'width: 100px;'),
