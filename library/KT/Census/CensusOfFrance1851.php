 ...
 */
class KT_Census_CensusOfFrance1851 extends KT_Census_CensusOfFrance implements KT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new KT_Census_CensusColumnOccupation($this, 'Professions', ''),
			...
			new KT_Census_CensusColumnAge($this, 'Âge', 'Âge'),
			new KT_Census_CensusColumnNull($this, 'Fr', 'Français d’origine'),
			new KT_Census_CensusColumnNull($this, 'Nat', 'Naturalisés français'),
			new KT_Census_CensusColumnNull($this, 'Etr', 'Étrangers (indiquer leur pays d’origine)'),
		);
	}
}
