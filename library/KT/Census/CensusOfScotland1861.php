 ...
 */
class KT_Census_CensusOfScotland1861 extends KT_Census_CensusOfScotland implements KT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new KT_Census_CensusColumnNull($this, 'Infirm', 'Whether blind or deaf-and-dumb'),
			new KT_Census_CensusColumnNull($this, 'School', 'Number of children between 5 and 13 attending school'),
		);
	}
}
