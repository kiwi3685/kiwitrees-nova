 ...
 */
class KT_Census_CensusOfIreland1901 extends KT_Census_CensusOfIreland implements KT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new KT_Census_CensusColumnAgeMale($this, 'Age', 'Age at last birthday'),
