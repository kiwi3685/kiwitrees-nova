 ...
 */
class KT_Census_CensusOfEngland1841 extends KT_Census_CensusOfEngland implements KT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			new KT_Census_CensusColumnFullName($this, 'Name', 'Name', 'width: 250px;'),
			...
			new KT_Census_CensusColumnBornForeignParts($this, 'BoE', 'Born outside England'),
		);
	}
}
