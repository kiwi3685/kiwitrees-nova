 ...
 */
class KT_Census_CensusOfScotland1871 extends KT_Census_CensusOfScotland implements KT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new KT_Census_CensusColumnNull($this, 'Infirm', 'Whether deaf-and-dumb, blind, imbecile, idiot or lunatic'),
			new KT_Census_CensusColumnNull($this, 'School', 'Number of children between 5 and 13 attending school or educated at home'),
		);
	}
}
