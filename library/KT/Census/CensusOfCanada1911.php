 ...
 */
class KT_Census_CensusOfCanada1911 extends KT_Census_CensusOfCanada implements KT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new KT_Census_CensusColumnBirthMonth($this, 'Birth Month', 'Month of  Birth'),
			new KT_Census_CensusColumnBirthYear($this, 'Birth Year', 'Year of Birth'),
			new KT_Census_CensusColumnAge($this, 'Age', 'Age at last birthday'),
			new KT_Census_CensusColumnBirthPlaceSimple($this, 'Birth Place', 'Country or Place of Birth (if Canada, specify province or territory)'),
