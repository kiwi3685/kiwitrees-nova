...
class KT_Gedcom_Code_Stat {
	...
	public static function statusCodes($tag) {
		...
		default:
			trigger_error('Internal error - bad argument to KT_Gedcom_Code_Stat::statusCodes("'.$tag.'")', E_USER_ERROR);
		}
	}
	...
	public static function statusName($status_code) {
		...
		case 'BIC':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Born in the covenant');
		case 'CANCELED':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Sealing cancelled (divorce)');
		case 'CHILD':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Died as a child: exempt');
		case 'CLEARED':
			// This status appears in PGV, but not in the GEDCOM 5.5.1 specification.
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				 KT_I18N::translate('Cleared but not yet completed');
		case 'COMPLETED':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Completed; date unknown');
		case 'DNS':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Do Not Seal: unauthorized');
		case 'DNS/CAN':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Do Not Seal, previous sealing cancelled');
		case 'EXCLUDED':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Excluded from this submission');
		case 'INFANT':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Died as an infant: exempt');
		case 'PRE-1970':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Completed before 1970; date not available');
		case 'STILLBORN':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Stillborn: exempt');
		case 'SUBMITTED':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Submitted but not yet cleared');
		case 'UNCLEARED':
			return /* I18N: LDS sealing status; see http://en.wikipedia.org/wiki/Sealing_(Latter_Day_Saints) */
				KT_I18N::translate('Uncleared: insufficient data');
		default:
			return $status_code;
		}
	}
