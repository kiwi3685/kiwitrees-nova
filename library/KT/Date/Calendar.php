...
class KT_Date_Calendar {
	...
	static function NUM_TO_MONTH_NOMINATIVE($n, $leap_year) {
		switch ($n) {
		case 1:  return KT_I18N::translate_c('NOMINATIVE', 'January');
		case 2:  return KT_I18N::translate_c('NOMINATIVE', 'February');
		case 3:  return KT_I18N::translate_c('NOMINATIVE', 'March');
		case 4:  return KT_I18N::translate_c('NOMINATIVE', 'April');
		case 5:  return KT_I18N::translate_c('NOMINATIVE', 'May');
		case 6:  return KT_I18N::translate_c('NOMINATIVE', 'June');
		case 7:  return KT_I18N::translate_c('NOMINATIVE', 'July');
		case 8:  return KT_I18N::translate_c('NOMINATIVE', 'August');
		case 9:  return KT_I18N::translate_c('NOMINATIVE', 'September');
		case 10: return KT_I18N::translate_c('NOMINATIVE', 'October');
		case 11: return KT_I18N::translate_c('NOMINATIVE', 'November');
		case 12: return KT_I18N::translate_c('NOMINATIVE', 'December');
		default: return '';
		}
	}
	static function NUM_TO_MONTH_GENITIVE($n, $leap_year) {
		switch ($n) {
		case 1:  return KT_I18N::translate_c('GENITIVE', 'January');
		case 2:  return KT_I18N::translate_c('GENITIVE', 'February');
		case 3:  return KT_I18N::translate_c('GENITIVE', 'March');
		case 4:  return KT_I18N::translate_c('GENITIVE', 'April');
		case 5:  return KT_I18N::translate_c('GENITIVE', 'May');
		case 6:  return KT_I18N::translate_c('GENITIVE', 'June');
		case 7:  return KT_I18N::translate_c('GENITIVE', 'July');
		case 8:  return KT_I18N::translate_c('GENITIVE', 'August');
		case 9:  return KT_I18N::translate_c('GENITIVE', 'September');
		case 10: return KT_I18N::translate_c('GENITIVE', 'October');
		case 11: return KT_I18N::translate_c('GENITIVE', 'November');
		case 12: return KT_I18N::translate_c('GENITIVE', 'December');
		default: return '';
		}
	}
	static function NUM_TO_MONTH_LOCATIVE($n, $leap_year) {
		switch ($n) {
		case 1:  return KT_I18N::translate_c('LOCATIVE', 'January');
		case 2:  return KT_I18N::translate_c('LOCATIVE', 'February');
		case 3:  return KT_I18N::translate_c('LOCATIVE', 'March');
		case 4:  return KT_I18N::translate_c('LOCATIVE', 'April');
		case 5:  return KT_I18N::translate_c('LOCATIVE', 'May');
		case 6:  return KT_I18N::translate_c('LOCATIVE', 'June');
		case 7:  return KT_I18N::translate_c('LOCATIVE', 'July');
		case 8:  return KT_I18N::translate_c('LOCATIVE', 'August');
		case 9:  return KT_I18N::translate_c('LOCATIVE', 'September');
		case 10: return KT_I18N::translate_c('LOCATIVE', 'October');
		case 11: return KT_I18N::translate_c('LOCATIVE', 'November');
		case 12: return KT_I18N::translate_c('LOCATIVE', 'December');
		default: return '';
		}
	}
	static function NUM_TO_MONTH_INSTRUMENTAL($n, $leap_year) {
		switch ($n) {
		case 1:  return KT_I18N::translate_c('INSTRUMENTAL', 'January');
		case 2:  return KT_I18N::translate_c('INSTRUMENTAL', 'February');
		case 3:  return KT_I18N::translate_c('INSTRUMENTAL', 'March');
		case 4:  return KT_I18N::translate_c('INSTRUMENTAL', 'April');
		case 5:  return KT_I18N::translate_c('INSTRUMENTAL', 'May');
		case 6:  return KT_I18N::translate_c('INSTRUMENTAL', 'June');
		case 7:  return KT_I18N::translate_c('INSTRUMENTAL', 'July');
		case 8:  return KT_I18N::translate_c('INSTRUMENTAL', 'August');
		case 9:  return KT_I18N::translate_c('INSTRUMENTAL', 'September');
		case 10: return KT_I18N::translate_c('INSTRUMENTAL', 'October');
		case 11: return KT_I18N::translate_c('INSTRUMENTAL', 'November');
		case 12: return KT_I18N::translate_c('INSTRUMENTAL', 'December');
		default: return '';
		}
	}
	static function NUM_TO_SHORT_MONTH($n, $leap_year) {
		switch ($n) {
		case 1:  return KT_I18N::translate_c('Abbreviation for January',   'Jan');
		case 2:  return KT_I18N::translate_c('Abbreviation for February',  'Feb');
		case 3:  return KT_I18N::translate_c('Abbreviation for March',     'Mar');
		case 4:  return KT_I18N::translate_c('Abbreviation for April',     'Apr');
		case 5:  return KT_I18N::translate_c('Abbreviation for May',       'May');
		case 6:  return KT_I18N::translate_c('Abbreviation for June',      'Jun');
		case 7:  return KT_I18N::translate_c('Abbreviation for July',      'Jul');
		case 8:  return KT_I18N::translate_c('Abbreviation for August',    'Aug');
		case 9:  return KT_I18N::translate_c('Abbreviation for September', 'Sep');
		case 10: return KT_I18N::translate_c('Abbreviation for October',   'Oct');
		case 11: return KT_I18N::translate_c('Abbreviation for November',  'Nov');
		case 12: return KT_I18N::translate_c('Abbreviation for December',  'Dec');
		default: return '';
		}
	}
	...
	static function LONG_DAYS_OF_WEEK($n) {
		switch ($n) {
		case 0: return KT_I18N::translate('Monday');
		case 1: return KT_I18N::translate('Tuesday');
		case 2: return KT_I18N::translate('Wednesday');
		case 3: return KT_I18N::translate('Thursday');
		case 4: return KT_I18N::translate('Friday');
		case 5: return KT_I18N::translate('Saturday');
		case 6: return KT_I18N::translate('Sunday');
		}
	}
	static function SHORT_DAYS_OF_WEEK($n) {
		switch ($n) {
		case 0: return KT_I18N::translate('Mon');
		case 1: return KT_I18N::translate('Tue');
		case 2: return KT_I18N::translate('Wed');
		case 3: return KT_I18N::translate('Thu');
		case 4: return KT_I18N::translate('Fri');
		case 5: return KT_I18N::translate('Sat');
		case 6: return KT_I18N::translate('Sun');
		}
	}
	...
	function convert_to_cal($calendar) {
		switch ($calendar) {
		case 'gregorian':
			return new KT_Date_Gregorian($this);
		case 'julian':
			return new KT_Date_Julian($this);
		case 'jewish':
			return new KT_Date_Jewish($this);
		case 'french':
			return new KT_Date_French($this);
		case 'hijri':
			return new KT_Date_Hijri($this);
		case 'jalali':
			return new KT_Date_Jalali($this);
		default:
			return $this;
		}
	}
	...
	function FormatISOWeekday() {
		return KT_I18N::digits($this->minJD % 7 + 1);
	}
	...
	function FormatNumericWeekday() {
		return KT_I18N::digits(($this->minJD + 1) % $this->NUM_DAYS_OF_WEEK());
	}

	function FormatDayOfYear() {
		return KT_I18N::digits($this->minJD - $this->YMDtoJD($this->y, 1, 1));
	}
...
//		$URL='calendar.php?cal='.rawurlencode((string) $this->CALENDAR_ESCAPE());
		$URL='module.php?mod=list_calendar&mod_action=show&ged=Osborne&cal='.rawurlencode((string) $this->CALENDAR_ESCAPE());
		$view="year";
