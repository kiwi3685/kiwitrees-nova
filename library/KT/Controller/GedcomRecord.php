...
class KT_Controller_GedcomRecord extends KT_Controller_Page {
	...
	public function __construct() {
		...
		if ($this->record) {
			...
			if ($this->record->canDisplayName()) {
				...
				$this->setPageTitle(KT_Gedcom_Tag::getLabel($this->record->getType()));
			}
		} else {
			// No such record
			$this->setPageTitle(KT_I18N::translate('Private'));
		}
	}
}
