...
class KT_Controller_Page extends KT_Controller_Base {
	...
	public function __construct() {
		...
		$this
			...
			->addExternalJavascript(KT_JQUERYUI_JS) // Needed for autocomplete js
...
//			->addExternalJavascript(KT_PROGRESS_JS)
	...
	protected function pageFooter() {
		global $view, $start_time, $PRIVACY_CHECKS;

		if (KT_THEME_DIR == 'themes/_administration/') {
			require KT_ROOT . KT_THEME_DIR . 'footer.php';
		} else {
			require KT_ROOT . 'footer.php';
		}
