	...
	<form name="people" method="get" action="?">
		...
		<div id="row1">
			<div class="chart_options">
				...
				<input data-autocomplete-type="INDI" type="text" name="pid1" id="pid1" value="<?php echo $pid1 ?>">
			</div>
			<div class="chart_options">
				<label for = "pid2"><?php echo KT_I18N::translate('Individual 2') ?></label>
				<input data-autocomplete-type="INDI" type="text" name="pid2" id="pid2" value="<?php echo $pid2 ?>">
			</div>
