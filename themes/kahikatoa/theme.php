 ...
 * @ fal	= light
 */
$iconStyle	= 'fa-solid'; // fontawesome style set. Must also be changed in scss file
...
/**
 * Icon notes
 * icon-resn-confidential	fa-ban alert
 * icon-resn-none			fa-circle-o
 * icon-resn-locked			fa-lock
 * icon-resn-privacy		fa-unlock-alt
 */
