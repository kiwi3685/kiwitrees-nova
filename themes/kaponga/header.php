...
<html <?php echo KT_I18N::html_markup(); ?>>
	<head>
		...
		<link rel="stylesheet" href="<?php echo KT_THEME_URL; ?>css/kaponga.min.css">
		...
		<?php if ($view !='simple') { ?>
			...
			<nav class="grid-x">
				...
				<div class="top-bar second-top-bar">
					<div class="top-bar-left main-menu">
						<!-- responsive menu -->
						...
						<!-- normal menu -->
						<ul id="kiwitrees-menu" class="menu vertical medium-horizontal" data-responsive-menu="accordion medium-dropdown">
							<?php if ($show_widgetbar) { ?>
								<button class="button clear widget_dropdown" type="button" data-toggle="widgetDropdown">
									<i class="<?php echo $iconStyle; ?> fa-sign-in-alt fa-2x" data-fa-transform="rotate-90"></i>
								</button>
							<?php }
