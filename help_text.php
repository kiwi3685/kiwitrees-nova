...
case 'edit_edit_raw':
	...
	$text =
		...
		'<br/><br/>'.
		/* I18N: %s is a URL */ KT_I18N::translate('You can download a copy of the GEDCOM specification from %s.', '<a href="http://kiwitrees.net/wp-content/uploads/2016/03/ged551-5.pdf">http://kiwitrees.net/wp-content/uploads/2016/03/ged551-5.pdf</a>');
	break;
...
case 'edituser_contact_meth':
	...
	$text	= KT_I18N::translate('Kiwitrees has several different contact methods. The administrator determines which method will be used to contact him. You have control over the method to be used to contact <u>you</u>. Depending on site configuration, some of the listed methods may not be available to you.');
	$text.='<br/><br/><dl><dt>';
	$text.=I18N::translate('Internal messaging');
	$text.='</dt><dd>';
	$text.=I18N::translate('With this option, the kiwitrees internal messaging system will be used and no emails will be sent.<br><br>You will receive only <u>internal</u> messages from the other users. When another site user sends you a message, that message will appear in the Message block if it is included among your widgets. If you have removed this block from your widget bar, you will not see any messages. They will, however, show up as soon as you configure the widget bar to again have the Message block.');
	$text.='</dd><dt>';
	$text.=I18N::translate('Internal messaging with emails');
	$text.='</dt><dd>';
	$text.=I18N::translate('This option is like kiwitrees internal messaging, with one addition. As an extra, a copy of the message will also be sent to the email address you configured on your Account page.<br><br>This is the default contact method.');
	$text.='</dd><dt>';
	$text.=I18N::translate('Mailto link');
	$text.='</dt><dd>';
	$text.=I18N::translate('With this option, you will only receive email messages at the address you configured on your Account page. The messaging system internal to kiwitrees will not be used at all, and there will never be any messages in the Message block on your widget bar.');
	$text.='</dd><dt>';
...
case 'username':
	$title	= '';
	$text	=	KT_I18N::translate('User names are case-insensitive and ignore accented letters, so that “chloe”, “chloë”, and “Chloe” are considered to be the same. Usernames may not contain the following characters: &lt; &gt; " %% { } ;');
	break;
...
if ($use_title) { ?>
	<h6 class="help_header"><?php echo $title; ?></h6>
<?php } ?>
<div class="help_content"><?php echo $text; ?></div>
<?php
